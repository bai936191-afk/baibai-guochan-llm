...
describe('WebSocket memory events', () => {
  ...
  it('forwards terminal tool progress with live output to the desktop client', () => {
    expect(translateCliMessage({
      type: 'tool_progress',
      tool_use_id: 'tool-1',
      tool_name: 'run_command',
      progress_id: 'tool-1-progress-1',
      output: 'line 2\n',
      full_output: 'line 1\nline 2\n',
      ...
      timeout_ms: 300000,
      task_id: 'task-1',
    }, 'session-progress')).toEqual([
      {
        type: 'tool_progress',
        toolUseId: 'tool-1',
        toolName: 'run_command',
        progressId: 'tool-1-progress-1',
        output: 'line 2\n',
        fullOutput: 'line 1\nline 2\n',
