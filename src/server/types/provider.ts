...
export const BUILT_IN_PROVIDER_IDS = [] as const
...
export const ProviderAvailableModelSchema = z.object({
  id: z.string().min(1),
  contextWindow: AutoCompactWindowSchema.optional(),
  capabilities: z.array(z.string().min(1)).optional(),
})
export const ProviderAvailableModelsSchema = z.array(ProviderAvailableModelSchema)
...
export const SavedProviderSchema = z.object({
  ...
  availableModels: ProviderAvailableModelsSchema.optional(),
...
export const UpdateProviderSchema = z.object({
  ...
  availableModels: ProviderAvailableModelsSchema.nullable().optional(),
  toolSearchEnabled: ToolSearchEnabledSchema.optional(),
  notes: z.string().optional(),
})
...
export const TestProviderSchema = z.object({
  ...
  authStrategy: ProviderAuthStrategySchema.optional(),
  apiFormat: ApiFormatSchema.default('openai_chat'),
})
...
export type ProviderAvailableModel = z.infer<typeof ProviderAvailableModelSchema>
