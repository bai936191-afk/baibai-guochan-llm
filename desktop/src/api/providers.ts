...
type ProviderModelsResponse = { models: Array<{ id: string; contextWindow?: number; capabilities?: string[] }> }
...
export const providersApi = {
  ...
  fetchModels(input: Omit<TestProviderConfigInput, 'modelId'>) {
    return api.post<ProviderModelsResponse>('/api/providers/models', input)
  },
