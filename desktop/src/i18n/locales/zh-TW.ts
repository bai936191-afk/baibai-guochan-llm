...
export const zh: Record<TranslationKey, string> = {
  ...
  'sidebar.copySessionId': '複製會話 ID',
  'sidebar.sessionIdCopied': '會話 ID 已複製。',
  'sidebar.exportSessionJson': '匯出 JSON',
  'sidebar.sessionExported': '會話 JSON 已匯出。',
  'sidebar.sessionExportFailed': '匯出會話失敗：{error}',
  ...
  'settings.general.notificationsTestTitle': '白白國產大模型通知已啟用',
  ...
  'chat.resetToPoint': '重置到此點',
  'chat.resetToPointConfirmTitle': '重置到此點？',
  'chat.resetToPointConfirmBody': '這會刪除這條訊息及其之後的回覆，並把這條訊息重新放回輸入框。',
  'chat.resetToPointConfirmAction': '重置到此點',
  'chat.resetToPointFailed': '重置失敗：{error}',
  ...
  'tool.runningCommand': '正在執行命令',
  'tool.liveOutput': '即時輸出',
  'tool.runningSeconds': '已執行 {seconds} 秒',
