...
export const jp: Record<TranslationKey, string> = {
  ...
  'sidebar.copySessionId': 'セッション ID をコピー',
  'sidebar.sessionIdCopied': 'セッション ID をコピーしました。',
  'sidebar.exportSessionJson': 'JSON をエクスポート',
  'sidebar.sessionExported': 'セッション JSON をエクスポートしました。',
  'sidebar.sessionExportFailed': 'セッションのエクスポートに失敗しました: {error}',
  ...
  'settings.general.notificationsTestTitle': '白白国产大模型 の通知が有効になりました',
  ...
  'chat.resetToPoint': 'ここまでリセット',
  'chat.resetToPointConfirmTitle': 'ここまでリセットしますか？',
  'chat.resetToPointConfirmBody': 'このメッセージ以降の返信を削除し、このメッセージを入力欄に戻します。',
  'chat.resetToPointConfirmAction': 'ここまでリセット',
  'chat.resetToPointFailed': 'リセットに失敗しました: {error}',
  ...
  'tool.runningCommand': 'コマンドを実行中',
  'tool.liveOutput': 'ライブ出力',
  'tool.runningSeconds': '{seconds} 秒実行中',
  'tool.liveLines': '{count} 行',
  'tool.terminal': 'ターミナル',
  'tool.stopped': '停止済み',
  ...
  'model.effort': '労力',
  'model.capability.reasoning': '推論',
  'model.capability.image': '画像',
