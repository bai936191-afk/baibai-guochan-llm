...
export const zh: Record<TranslationKey, string> = {
  ...
  'sidebar.exportSessionJson': '导出 JSON',
  'sidebar.sessionExported': '会话 JSON 已导出。',
  'sidebar.sessionExportFailed': '导出会话失败：{error}',
  ...
  'settings.providers.fetchModelsEmpty': '接口没有返回可用模型',
  ...
  'settings.general.notificationsTestTitle': '白白国产大模型通知已启用',
  ...
  'chat.resetToPoint': '重置到此点',
  'chat.resetToPointConfirmTitle': '重置到此点？',
  'chat.resetToPointConfirmBody': '这会删除这条消息及其之后的回复，并把这条消息重新放回输入框。',
  'chat.resetToPointConfirmAction': '重置到此点',
  'chat.resetToPointFailed': '重置失败：{error}',
  ...
  'tool.runningCommand': '正在运行命令',
  'tool.liveOutput': '实时输出',
  'tool.runningSeconds': '已运行 {seconds} 秒',
