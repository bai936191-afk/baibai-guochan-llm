export const en = {
  ...
  'settings.general.notificationsTestTitle': 'Baibai LLM notifications are enabled',
  ...
  'chat.resetToPoint': 'Reset to this point',
  'chat.resetToPointConfirmTitle': 'Reset to this point?',
  'chat.resetToPointConfirmBody': 'This will remove this message and later replies, then put this message back in the composer.',
  'chat.resetToPointConfirmAction': 'Reset to this point',
  'chat.resetToPointFailed': 'Reset failed: {error}',
  ...
  'tool.runningSeconds': '{seconds}s',
  'tool.liveLines': '{count} lines',
