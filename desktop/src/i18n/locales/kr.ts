...
export const kr: Record<TranslationKey, string> = {
  ...
  'sidebar.copySessionId': '세션 ID 복사',
  'sidebar.sessionIdCopied': '세션 ID를 복사했습니다.',
  'sidebar.exportSessionJson': 'JSON 내보내기',
  'sidebar.sessionExported': '세션 JSON을 내보냈습니다.',
  'sidebar.sessionExportFailed': '세션 내보내기 실패: {error}',
  ...
  'settings.providers.fetchModelsEmpty': 'The endpoint did not return any usable models',
  'settings.providers.fetchModelsFailed': 'Failed to fetch models: {error}',
  ...
  'settings.general.notificationsTestTitle': '白白国产大模型 알림이 사용 설정되었습니다',
  ...
  'chat.resetToPoint': '이 지점으로 재설정',
  'chat.resetToPointConfirmTitle': '이 지점으로 재설정할까요?',
  'chat.resetToPointConfirmBody': '이 메시지와 이후 응답을 삭제하고 이 메시지를 입력창에 다시 넣습니다.',
  'chat.resetToPointConfirmAction': '이 지점으로 재설정',
  'chat.resetToPointFailed': '재설정 실패: {error}',
  ...
  'tool.runningCommand': '명령 실행 중',
  'tool.liveOutput': '실시간 출력',
  'tool.runningSeconds': '{seconds}초 실행 중',
  'tool.liveLines': '{count}줄',
  'tool.terminal': '터미널',
  'tool.stopped': '중지됨',
  ...
  'model.effort': '노력',
  'model.capability.reasoning': '추론',
  'model.capability.image': '이미지',
